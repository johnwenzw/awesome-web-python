...
def has_request_arg(fn):
    ...
    for name, parma in parmas.items():
        if name == 'request':
            found = True
            continue
        if found and (parma.kind != inspect.Parameter.VAR_KEYWORD and parma.kind != inspect.Parameter.KEYWORD_ONLY and parma.kind != inspect.Parameter.VAR_POSITIONAL):
